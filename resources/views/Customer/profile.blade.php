            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="card mb-4">
                        ...
                        @if ($data->Gender == 'male')
                            <img src="../img/ProfilePics/Placeholder_PFP_Male.jpg" class="rounded-circle img-fluid" style="width: 273px;">
                        @elseif ($data->Gender == 'female')
                            <img src="../img/ProfilePics/Placeholder_PFP_Female.jpg" class="rounded-circle img-fluid" style="width: 273px;">
                        @else
                            <img src="../img/ProfilePics/Placeholder_PFP_Other.png" class="rounded-circle img-fluid" style="width: 273px;">
                        @endif
...
@else
    ...
    <a href="{{ url('customerRegister') }}"style="color: #23B35A">Sign up here</a>.</p>
@endif
