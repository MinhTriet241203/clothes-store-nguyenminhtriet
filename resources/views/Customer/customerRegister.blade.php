                    ...
                    <form action="{{ url('saveCustomer') }}" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input id="username" type="text" class="form-control" placeholder="Username"
                                name="userName" value="{{ isset($data) ? $data->username : old('userName') }}" <?php echo isset($data) !== null ? 'readonly' : ''?>>
                        </div>
                        @error('userName')
                        ...
                        <div class="form-group">
                            ...
                            <input id="name" type="text" class="form-control" placeholder="Name" name="name"
                                value="{{ isset($data) ? $data->name : old('name') }}" <?php echo isset($data) !== null ? 'readonly' : ''?>>
                        </div>
                        @error('name')
                            <div class="alert alert-danger" role="alert">
                                {{ $message }}
                        ...
                        <div class="form-group">
                            ...
                            <input id="email" type="email" class="form-control" placeholder="Demo@gmail.com"
                                name="email" value="{{ isset($data) ? $data->email : old('email') }}" <?php echo isset($data) !== null ? 'readonly' : ''?>>
                        </div>
                        @error('email')
                            <div class="alert alert-danger" role="alert">
                                {{ $message }}
